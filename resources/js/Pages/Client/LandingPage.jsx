...
export default function () {
    ...
    return (
        <div className="">
            ...
            <section id="pictures" className="lg:mx-16 md:mx-8 mx-6">
                <div className="lg:my-36 md:my-24 my-12 flex justify-center gap-10">
                    <div className="lg:w-[340px] lg:h-[500px] lg:block hidden w-full h-[400px] bg-slate-500 md:rounded-xl rounded-md overflow-hidden img-container">
                        <img
                    ...
                    <div className="flex flex-col lg:gap-10 md:gap-4 gap-2">
                        <div className="flex lg:gap-10 md:gap-4 gap-2">
                            <div className="md:w-[260px] w-1/2  lg:h-[300px] h-full bg-slate-500 md:rounded-xl rounded-md overflow-hidden img-container">
                                <img
                            ...
                            <div className="flex flex-col w-1/2 md:w-auto lg:gap-10 md:gap-4 gap-2">
                                <div className="md:w-[400px] w-full lg:h-[130px] h-1/2 bg-slate-500 md:rounded-xl rounded-md overflow-hidden img-container">
                                    <img
                        ...
                        <div className="w-full h-[160px] bg-slate-500 md:rounded-xl rounded-md overflow-hidden img-container">
                            <img
            ...
            <section className="lg:py-16 py-12 lg:mx-16 md:mx-8 mx-3">
                <div className="flex md:flex-row flex-col gap-1 lg:justify-evenly justify-between">
                    <p
                        id="layanan-kiri"
                        className={`w-1/5 transition-all lg: duration-700 scroll-element lg:block hidden ${
                    ...
                    <h2
                        id="layanan-tengah"
                        className={`lg:w-[30%] md:w-1/2 w-full md:text-left text-center font-semibold md:text-[30px] text-lg leading-relaxed transition-all delay-150 duration-[900ms] scroll-element ${
                    ...
                    <p
                        id="layanan-kanan"
                        className={`lg:w-1/4 md:w-[40%] w-full indent-2 md:indent-0 md:pt-2 pt-5 text-justify text-lg duration-[1100ms] delay-300 scroll-element ${
